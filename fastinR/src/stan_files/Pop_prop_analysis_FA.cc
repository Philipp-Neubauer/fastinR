...
#include "Pop_prop_analysis_FA.hpp"

RCPP_MODULE(stan_fit4Pop_prop_analysis_FA_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_Pop_prop_analysis_FA")
