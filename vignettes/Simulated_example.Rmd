...
Cov.Combined <- run_MCMC(datas=dats.subset,Covs=Covs,nIter=100000,nBurnin=10000,nChains=3,nThin=10,Data.Type='Combined.Analysis',Analysis.Type='Analysis.with.Covariates',Rnot=1,Rnot_SI=1,even=2,plott=F,spawn=T)
```
