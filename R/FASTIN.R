FASTIN <- function(SI.data=NULL,FA.data=NULL,Groups=NULL,Covariates=NULL,eveness=0.1,nIter=10000,nBurnin=5000,Analysis.Type='Pop.proportions.only'){
  
  # set up class switches
  SI=F;FA=F
  ...
  outputs <- switch(Analysis.Type,
                    Pop.proportions.only = Pop.prop.analysis(datas,nIter,nBurnin),
                    Pop.and.Ind.proportions = Pop.and.Ind.props(datas,nIter,nBurnin),
                    Grouped.Analysis.Linear.Model = Grouped.analysis(datas,nIter,nBurnin,Groups = Groups),
                    Analysis.with.Covariates = Analysis.with.Cov(datas,nIter,nBurnin,Covariates = Covariates),
                    Grouped.Analysis.with.Covariates = Grouped.Analysis.with.Cov(datas,nIter,nBurnin,Covariates = Covariates,Groups = Groups)
  )
