...
mean_cs=matrix(rlnorm(n.fats*n.preys,0,cvar),n.preys,n.fats) # rtnorm is a truncated normal, with lower truncation set to 0
...
########## set mean_c to 1
    ...
    mean_cs=matrix(1,n.preys,n.fats) # rtnorm is a truncated normal, with lower truncation set to 0
    
    var_coeffs = matrix(1,n.preys,n.fats)  # set the variance to some constant - pretty close, at least for FA whose CC isn't too far from 1 (Iverson 2004 graphs)
    tau_coeffs = 1/var_coeffs
