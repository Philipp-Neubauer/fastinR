...
<<Individual estimates for Shrimp treatment,results='hide',eval=FALSE>>=
...
<<Marker Comparison SF,fig.width=12,fig.cap='Posterior distributions of diet proportions for SF treatment squid from combined markers, grouping fish species post MCMC',out.width='0.75\\textwidth'>>=
# combining individual elements to a named list
Pop.list.SF <- list(
...
<<Grouped plot,fig.width=10,fig.cap='Posterior distributions at the popualtion level for feeding groups and at the individual level for individual squid from all treatments using combined markers',out.width='0.75\\textwidth'>>=
