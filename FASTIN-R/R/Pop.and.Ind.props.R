...
.PopandIndprops.SI <- function(datas,nIter=10000,nBurnin=1000,nChains=1,nThin=10,plott=T)
{
    ...
    jagsdata <- list(
        ...
        preds.SI = matrix(unlist(datas$datas.SI$preds.SI),datas$n.preds,datas$datas.SI$isos),
...
jagsdata <- list(    
  ...
  Rnot_SI = datas$datas.SI$Rnot.SI,
  ni.SI = datas$datas.SI$ni.SI,
  preds.SI = matrix(unlist(datas$datas.SI$preds.SI),datas$n.preds,datas$datas.SI$iso),
  preym.SI = datas$datas.SI$preym.SI,  
  ...
  m.fats = datas$datas.FA$m.fats,
  ni = datas$datas.FA$ni,
  preds = matrix(datas$datas.FA$preds,datas$n.preds, datas$datas.FA$m.fats),
  preym = datas$datas.FA$preym,
