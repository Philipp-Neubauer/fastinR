...
test_that('Ind Props with FA give sensible answers',{
  ...
  dat <- run_MCMC(dats,nIter=10000,nBurnin=5000,nChains=3,nThin=10,Data.Type='Fatty.Acid.Profiles',Analysis.Type='Individual.proportions',even=5,plott=T)
...
test_that('Pop Props with SI give sensible answers',{
  ...
  dat <- run_MCMC(datas,nIter=10000,nBurnin=1000,nChains=3,nThin=10,Data.Type='Stable.Isotopes',Analysis.Type='Individual.proportions',even=5,plott=F)
...
test_that('Pop Props with combined give sensible answers',{
  ...
  dat <- run_MCMC(dats,nIter=10000,nBurnin=1000,nChains=3,nThin=10,Data.Type='Combined.Analysis',Analysis.Type='Individual.proportions',even=0.1,plott=F)
