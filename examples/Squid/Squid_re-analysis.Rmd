...
fish.mean <- sum((n.fish/total.fish)*fish.means)

## Var = \Sum w_i((\mu_i-mu)^2+SD_i^2)

fish.var <- sum((n.fish/total.fish)*((fish.means-fish.mean)^2+fish.vars))

# using a gamma model for fat.cont gives

fish.scale = fish.var/fish.mean
fish.shape = fish.mean/fish.scale
# plot it
hist(rgamma(10000,shape=fish.shape,scale=fish.scale),30)

# a log normal model gives
